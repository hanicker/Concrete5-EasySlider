						...
						$('.easysliderslideshow')
								.each(
										function(index) {
											...
											var easyslider_slideWidth = $(easyslider_currentSlideshow).width();//690;
											...
											function easyslider_show_next_slide() {
												$('.rightControl',easyslider_currentSlideshow).click();
											}
											...
											function easyslider_setup_control_panel() {
												var control_panel = $('.slideshow_control_panel',easyslider_currentSlideshow);
